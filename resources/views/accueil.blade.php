...
@section('content')
    <div id="carouselExampleIndicators" class=" carousel border border-1 slide container-fluid p-0 m-0 position-relative" data-bs-ride="carousel">
        <div class="" id="carouselExampleIndicators-next-div">
            ...
            <div class="d-flex justify-content-center flex-column align-items-start div-youthway-text ">
                    <div class=" text-youthway" id="text-youthway">
                        <p class="text-white p-0 mb-2">
                            <span class=" text-uppercase">YouthWay; <br> </span>
                        </p>
                        <p class="text-white" id="p-particulier">
                            Nous sommes le plus grand Bénin qui vient <br>
                            L'Afrique meilleure de demain, c'est nous!✊
                        </p>

                        <a href="#presentation" class="rounded rounded-pill  py-1 fs-4 border border-2 ms-lg-0 border-white text-white call-to-discover-button" id="discover-button">
                            Découvrons plus?
                        </a>
                    </div>
            </div>

            <div class="carousel-inner" id="carousel-firstbanner-hp">
                <div class="carousel-item active">
                    <img src="{{ asset('images/card/1.png') }}" class="d-block w-100" alt="..." style="object-position: 100%; object-fit:cover;">
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('images/card/1.png') }}" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item"  >
                    <img src="{{ asset('images/card/1.png') }}" class="d-block w-100" alt="...">
                </div>
            </div>
            {{-- <div class="d-flex justify-content-center align-items-center" id="presentation" >
    ...
    <section class=" pb-5 m-0 d-flex justify-content-center">
    ...
    <section class="atouts container">
        <div class="atouts-title mb-5">
            <h1 class=" h1-rosette-presentation justify-content-flex-start align-items-center d-flex fs-1">
    ...
    <section class="actualites my-5 container pt-5">
        ...
        <div class="text-center my-5"><a href="#" class="lien-historique mt-2">Rejoignez-nous en tant que
