...
@section('content')
    ...
    <section class="d-flex justify-content-center align-items-center py-5" style="background-color: #FF000007;">
        <div class="d-flex justify-content-between mt-5 pt-3" style="width: 75%; margin-right:60px;">
            <div>
                <h1 class=" rosette-text-orange fw-bold text-uppercase">Youthway <span class="fs-1">,</span></h1>
                <h3 class="my-3">Organisation internationale à but non lucratif</h3>
                <p  style="line-height: 20px; width:80%; line-height: 25px">
            ...
            <div class=" main-carousel-content   " style="width: 70%;">
    ...
    <section class=" pb-5 mt-5 m-0 d-flex justify-content-center " style="padding-bottom:30px;">
    ...
    <div class="container-fluid py-5" style="background-color: #0000FF09">
        <section class="atouts container pt-5 ">
            <div class="atouts-title mb-5">
                <h1
                class=" fs-3 h1-rosette-presentation justify-content-flex-start align-items-center d-flex fw-bold">
    ...
    {{-- Activité section --}}
    <div style="background-color: #FF800008">
