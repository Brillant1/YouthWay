            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Ajout flash Info</a></li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    ...
                    @if (session('addFlashMessage'))
                        <div class="alert alert-success my-3">
                            <span>{{ session('addFlashMessage') }}</span>
                        </div>
                    @endif
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Ajout flash Info  </h4>
                            <a href="{{ route('flashInfos.index') }}" class="btn btn-primary">
                        ...
                        <div class="card-body">
                            <form action="{{ route('flashInfos.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="info" class="form-control" id="info" cols="30" rows="5" required></textarea>
                                        </div>
                                    </div>
