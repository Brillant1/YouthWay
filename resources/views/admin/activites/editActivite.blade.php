            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Edit activité</a></li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit activité  </h4>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="titre" id="titre" value="{{ $activite->titre }}" required>
                                        </div>
                                    </div>
                                            ...
                                            <select class=" form-control " name="domaine_id">
                                                @if (sizeof($domaines)>0)
                                                    @foreach ($domaines as $domaine)
                                                        <option value="{{ $domaine->id }}" @if ( old('domaine_id', $activite->domaine_id) == $domaine->id)    selected
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="date_debut" id="date_debut" value="{{ $activite->date_debut }}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-16 col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="date_fin" id="date_fin" required value="{{ $activite->date_fin }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col col-lg-12">
                                        <div class="form-group" >
                                            ...
                                            <textarea class="form-control" cols="30" rows="10"  id="editor" name="description" required> {{ $activite->description }} </textarea>
                                        </div>
                                    ...
                                    <div class="input-group control-group increment">
                                        ...
                                        <img src="{{ asset('storage/' .$activite->photo) }}" alt="" class="mt-5 ms-0 " width="100" height="100">
                                    </div>
