        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="row tab-content">
                    ...
                    @if(session('updateDomaineMessage'))
                        <div class="alert alert-success">
                            <span>{{ session('updateDomaineMessage') }}</span>
                        </div>
                    @endif
                    @if (session('deleteDomaineMessage'))
                        <div class="alert alert-success py-3">
                            <span>{{ session('deleteDomaineMessage') }}</span>
                        </div>
                    @endif
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Liste des doamines d'action  </h4>
                                <a href="{{ route('domaines.create') }}" class="btn btn-primary">
                                ...
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            @if (sizeof($domaines)>0)
                                                @foreach ($domaines as $domaine)
                                                    <tr>
                                                        ...
                                                        <td>{{ $domaine->nom }}</td>
                                                        <td class="text-justify">{!! $domaine->description !!}</td>


                                                        <td class="d-flex align-items-center justify-content-center">
                                                            {{-- <a href="{{ route('domaines.show', ['domaine',$domaine]) }}" class="btn btn-sm text-primary ms-3">
                                                            ...
                                                            <a href="{{ route('domaines.edit', $domaine) }}"  class="btn btn-sm text-success">
                                                            ...
                                                            <a href="" title="Supprimer le édomaine"
                                                            class="btn btn-sm text-danger"
                                                            data-toggle="modal"
                                                            data-target="{{ '#deleteModalDomaine' . $domaine->id }}">
                                            ...
                                            <div class="modal fade" id="{{ 'deleteModalDomaine' . $domaine->id }}"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            Voulez-vous vraiment supprimer le résultat du :
                                                            <span class="text-danger"> {{ $domaine->nom }}
                                                        ...
                                                        <div class="modal-footer">
                                                            <form method="POST"
                                                                action="{{ route('domaines.destroy', ['domaine' => $domaine->id]) }}">
